...
const FoodDonationsPage = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-8 flex justify-center "  style={{ backgroundImage: "url('https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg')", backgroundSize: "cover", backgroundPosition: "center" }}>
      <div className="w-[75%] md:max-w-sm p-6 mt-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 p-4 text-center">Start a Food Donations Campaign</h1>
