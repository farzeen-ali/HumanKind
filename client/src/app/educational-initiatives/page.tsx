...
const EducationPage = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-8 flex justify-center "  style={{ backgroundImage: "url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwallpapers.com%2Feducational-background&psig=AOvVaw1w2p0Hv1PVy7Btu2qcLxzR&ust=1718139706402000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCNCItLD30YYDFQAAAAAdAAAAABAE')", backgroundSize: "cover", backgroundPosition: "center" }}>
      <div className="w-[75%] md:max-w-sm p-6 mt-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 p-4 text-center">Start an Educational Support Campaign</h1>
