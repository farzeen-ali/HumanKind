...
const EnvironmentPage = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-8 flex justify-center "  style={{ backgroundImage: "url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fslidechef.net%2Ftemplates%2Ffree-google-slides-education-background-powerpoint-templates%2F&psig=AOvVaw10gpueoQYZtsuobCIvIBDd&ust=1718140405719000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCOiDxvf50YYDFQAAAAAdAAAAABAE')", backgroundSize: "cover", backgroundPosition: "center" }}>
      <div className="w-[75%] md:max-w-sm p-6 mt-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 p-4 text-center">Start an Environment Protection Campaign</h1>
